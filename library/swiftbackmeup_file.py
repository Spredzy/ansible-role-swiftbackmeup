...
DOCUMENTATION = '''
---
module: swiftbackmeup_file
short_description: An Ansible module to manage swiftbackmeup file items in the configuration file
version_added: 2.2
options:
  state:
    required: false
...
- name: Remove a file backup item
  swiftbackmeup_file: config=/etc/swiftbackmeup.conf
                      name=my_special_file
                      state=absent
'''
