...
DOCUMENTATION = '''
---
module: swiftbackmeup_mariadb
short_description: An Ansible module to manage swiftbackmeup mariadb items in the configuration file
version_added: 2.2
options:
  state:
    required: false
...
- name: Create a backup item
  swiftbackmeup_mariadb: config=/etc/swiftbackmeup.conf
                         name=mydb1
                         database=mydb1
